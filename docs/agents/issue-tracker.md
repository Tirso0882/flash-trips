...
- **Name implementation context**: End each ticket body with one `Touches:` line that names up to three primary code paths and links the smallest relevant ADR set, for example `Touches: src/flash_trips/capabilities/trip_request/. See ADR 0008, ADR 0014.`
