...
from flash_trips.adapters.http.approvals import approval_router
from flash_trips.adapters.http.handbooks import handbook_router
...
def create_app(
    ...
    app.include_router(
        approval_router(trip_planning, access_token_verifier, planner_resolver)
    )
    app.include_router(
        handbook_router(trip_planning, access_token_verifier, planner_resolver)
    )
